          ...
          <div className="">
            ...
            <div className="mt-6 border-t border-b py-2">
              <div className="flex items-center justify-between">
                ...
                <p className="font-semibold text-gray-900">$ {totalToPay}</p>
              </div>
              <div className="flex items-center justify-between">
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <p className="text-2xl font-semibold text-gray-900">$ {totalToPay + 8.00}</p>
            </div>
          </div>
          <a
            className="group relative inline-block overflow-hidden border bg-teal-500 px-44 py-2 cursor-pointer focus:outline-none focus:ring"
